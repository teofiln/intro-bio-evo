...
| Clase | Fecha | Contenido | Quiz | Hoja de trabajo grupal |
|---|---|---|---|---|
| 1 | Mar 26 may | Introduccion; individuos vs poblaciones; rasgos y distribuciones de rasgos, definicion de evolucion; | No | No |
| 2 | Vie 29 may | Fosiles, homologias, biogeografia y evidencia directa contemporanea | No | W1: Distinguir plasticidad vs evolucion, Identificar lineas de evidencia |
| 3 | Mar 2 jun | Examen modulo Genetica | No | No |
| 4 | Vie 5 jun | Como estudiamos la evolucion: evidencia, inferencia, comparacion de hipotesis y limites | Quiz 1 (Clases 1-3) | W2: Interpretar datos evolutivos, Construir una explicacion evolutiva |
| 5 | Mar 9 jun | Hardy-Weinberg como expectativa nula: que pasaria si no actuaran fuerzas evolutivas | No | W3: Usar Hardy-Weinberg como linea base conceptual |
| 6 | Vie 12 jun | Mutacion y variacion heredable: origen de nuevos alelos, tipos basicos y errores frecuentes | No | No |
| 7 | Mar 16 jun | Seleccion natural, aptitud, adaptacion, tradeoffs y limites de la seleccion | No | W4: Predecir cambio poblacional bajo seleccion y justificar el razonamiento con evidencia |
| 8 | Vie 19 jun | Deriva genetica, efecto fundador, cuello de botella y cambio por azar | Quiz 2 (Clases 4-7) | No |
| 9 | Mar 23 jun | Migracion (flujo genico), conectividad poblacional y homogenizacion/diferenciacion genetica | No | W5: Distinguir seleccion, deriva y flujo genico en estudios de caso |
| 10 | Vie 26 jun | Especiacion: aislamiento reproductivo y divergencia, poblaciones, lineages, y especies, unidades de conservacion | No | No |
| 11 | Mar 30 jun | Macroevolucion: vincular cambio en poblaciones con diversificacion y extincion masiva a lo largo del tiempo | No | No |
| 12 | Vie 3 jul | Filogenias: lectura de arboles, nodos, clados, grupo hermano, ancestro comun y evolucion de rasgos | Quiz 3 (Clases 8-11) | W6: Interpretar filogenias y evitar errores comunes de lectura de arboles |
| 13 | Mar 7 jul | Aplicar evolucion a problemas actuales: resistencia, conservacion, cambio ambiental y salud humana | No | No |
| 14 | Vie 10 jul | Examen modulo Evolucion | No | No |
