...
* Definir los diferentes tipos de selección (balanceadora, disruptiva, direccional).
* Reconocer cómo la selección mantiene alelos a través de la ventaja del heterocigoto.
* Definir adaptacion como un rasgo heredable que aumenta la aptitud relative y origino por seleccion natural
...
## Y si la frecuencia de `S` empieza muy baja?
