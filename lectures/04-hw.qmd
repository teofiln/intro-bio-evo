...
## Antes de cualquier evento: frecuencias alelicas

![](04-assets/allele_frequencies-left.png){width=60%}

## Antes de cualquier evento: frecuencia y espacio
...
## Resumen completo (100 individuos)
...
## Ajuste aproximado vs desviacion clara
...
## 4 alelos en una poblacion diploide

Si hay 4 alelos ($A_1, A_2, A_3, A_4$), entonces:
...
Esto produce 10 clases genotipicas esperadas:

- 4 homocigotos: $A_1A_1$, $A_2A_2$, $A_3A_3$, $A_4A_4$
- 6 heterocigotos: $A_1A_2$, $A_1A_3$, $A_1A_4$, $A_2A_3$, $A_2A_4$, $A_3A_4$

::: {.fragment}
> Al aumentar alelos la cuenta crece rapido.
:::
