...
# ¿De dónde proviene la variación heredable? {background-color="#E8F5E9"}
...
## Un ejemplo simple: 1 locus

::: columns
::: {.column width="45%"}
Imagina un rasgo controlado por un solo locus.
...
::: columns
::: {.column width="45%"}
Ahora mantenemos el mismo valor genético base por genotipo,
pero agregamos un multiplicador ambiental pequeño y aleatorio para cada uno.

En esta simulación, cada genotipo recibe un cambio entre -10% y +10%.
...
::: columns
::: {.column width="45%"}
La herencia sigue siendo discreta en cada locus.

Pero al combinar muchos loci, la cantidad de genotipos posibles crece muchísimo y el rasgo se suaviza.
...
> alelos discretos -> variación continua
...
::: {.column width="55%"}
![](05-assets/09_twenty_loci_all_genotypes.png){fig-alt="Mapa de todos los genotipos posibles y su contribucion a la estatura para 20 loci." width=100%}
:::
:::
...
## Sustituciones: tres resultados frecuentes
...
Esto ocurre por la redundancia del código genético: varios codones pueden codificar el mismo aminoácido.
...
![05-assets/chromosomal-mutations.jpg]{fig-alt="Esquema de mutaciones cromosómicas: deleciones, duplicaciones, inversiones, translocaciones y aneuploidías." width=100%}

## Germinales vs somáticas

Otra clasificación importante depende de dónde ocurre la mutación:
...
## Conexión con mutación

Si un rasgo cuantitativo depende de muchos loci, ¿de dónde salen esos alelos?
...
Nuevos alelos
    ↓
Muchos loci contribuyen a un rasgo
    ↓
Variación fenotípica continua
    ↓
La selección actúa sobre esa variación
```
