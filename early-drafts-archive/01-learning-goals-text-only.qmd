...
## Evolución biológica y diversidad {background-color="#E8F5E9"}
...
- La evolución continúa ocurriendo en la actualidad. 
- Los seres humanos impactan directamente la biodiversidad, lo que puede afectar el potencial evolutivo futuro.

## Ancestro común y especies actuales {background-color="#E8F5E9"}
...
- Hace 3.8 mil millones de años, la vida en la Tierra consistía en organismos unicelulares similares a bacterias actuales. 
- Hay evidencia de eucariotas en el registro fósil desde hace aproximadamente mil millones de años; algunos fueron precursores de organismos multicelulares.
- El proceso evolutivo temprano de los eucariotas incluyó la fusión de células procariotas. 

## Cambio geológico y evolución biológica {background-color="#E8F5E9"}
...
- Los seres vivos han tenido una gran influencia en la composición de la atmósfera y en la superficie del planeta.

## Extinciones y continuidad de la vida {background-color="#E8F5E9"}

- Durante el curso de la evolución, solo un pequeño porcentaje de especies ha sobrevivido hasta hoy. 
- Las extinciones de fondo son un fenómeno normal. 
- Las tasas de extinción varían. 
- Ocurren extinciones masivas. 
- La extinción puede resultar de cambios ambientales. 
- La influencia humana puede estar causando una extinción masiva moderna.
- Las extinciones pueden crear oportunidades para que ocurra una mayor evolución en otros linajes.

## Ritmos de la evolución {background-color="#E8F5E9"}

- Las tasas de evolución varían. 
- Las tasas de especiación varían. 
- El cambio evolutivo a veces puede ocurrir rápidamente. 
- Algunos linajes permanecen relativamente sin cambios durante largos periodos de tiempo. 


# Evidencia de la evolución

## Evidencias de la evolución: visión general {background-color="#FFF3E0"}
...
## Evidencias en rasgos y adaptación {background-color="#FFF3E0"}
...
## Evidencias del registro fósil {background-color="#FFF3E0"}
...
## Otras líneas de evidencia evolutiva {background-color="#FFF3E0"}
...
## Mecanismos de la evolución: concepto base {background-color="#E3F2FD"}
...
## Mecanismos principales de cambio evolutivo {background-color="#E3F2FD"}
...
## Variación, genotipo y fenotipo {background-color="#E3F2FD"}
...
## Mutación y aparición de rasgos heredables {background-color="#E3F2FD"}
...
## Supervivencia, reproducción y adaptación {background-color="#E3F2FD"}
...
## Modos de selección natural I {background-color="#E3F2FD"}
...
## Modos de selección natural II {background-color="#E3F2FD"}
...
## Selección sexual y aptitud biológica {background-color="#E3F2FD"}
...
## Niveles de selección y factores aleatorios {background-color="#E3F2FD"}
...
## Efecto fundador y cuellos de botella {background-color="#E3F2FD"}
...
## Especie y especiación {background-color="#E3F2FD"}
...
## Hibridación y dirección evolutiva {background-color="#E3F2FD"}
