---
title: "Quiz 2B — CLAVE DE RESPUESTAS"
...
|:---:|:---:|---|
| 1 | **c** | Ventaja del heterocigoto en malaria mantiene polimorfismo (selección balanceadora) |
...
| 5 | **b** | Inserciones/deleciones no múltiplos de 3 en región codificante pueden causar frameshift |
| 6 | **b** | Desviación de HW sugiere violación de uno o más supuestos, no un mecanismo único automático |
| 7 | **b** | Método científico: hipótesis alternativas y predicciones comprobables contrastadas con datos |
| 8 | **c** | Selección diversificadora favorece extremos y reduce aptitud de intermedios |
| 9 | **b** | Solo mutaciones germinales son heredables y contribuyen directamente a evolución poblacional |
