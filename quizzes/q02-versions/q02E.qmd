---
title: "Quiz 2E: Métodos, Hardy-Weinberg, Mutación y Selección Natural"
...
**1.** Respecto a las mutaciones germinales y somáticas, ¿cuál de las siguientes afirmaciones es correcta?
...
**2.** ¿Cuál afirmación sobre mutaciones puntuales e inserciones/deleciones es correcta?
...
**3.** Para sustentar la hipótesis de que un rasgo es una adaptación producto de la selección natural, es necesario demostrar simultáneamente:
...
**4.** En el caso de la anemia falciforme en regiones donde la malaria es común, la persistencia del alelo S se explica mejor por:
...
**6.** En el enfoque científico visto en clase, después de plantear hipótesis alternativas sobre un patrón evolutivo, el siguiente paso clave es:
...
**7.** ¿Cuál de los siguientes escenarios describe mejor la selección diversificadora (disruptiva)?
...
**8.** Si una población se desvía de las frecuencias genotípicas esperadas por Hardy-Weinberg, la interpretación más apropiada es:
...
**9.** ¿Cuál afirmación resume mejor la relación entre mutación y selección natural?
...
**10.** En una población diploide con dos alelos (A y a), con frecuencias $f(A) = p = 0.7$ y $f(a) = q = 0.3$, la frecuencia esperada de heterocigotos (Aa) bajo Hardy-Weinberg es:
