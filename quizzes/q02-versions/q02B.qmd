---
title: "Quiz 2B: Métodos, Hardy-Weinberg, Mutación y Selección Natural"
...
**1.** En el caso de la anemia falciforme en regiones donde la malaria es común, la persistencia del alelo S se explica mejor por:
...
**3.** En una población diploide con dos alelos (A y a), con frecuencias $f(A) = p = 0.7$ y $f(a) = q = 0.3$, la frecuencia esperada de heterocigotos (Aa) bajo Hardy-Weinberg es:
...
**5.** ¿Cuál afirmación sobre mutaciones puntuales e inserciones/deleciones es correcta?
...
**6.** Si una población se desvía de las frecuencias genotípicas esperadas por Hardy-Weinberg, la interpretación más apropiada es:
...
**7.** En el enfoque científico visto en clase, después de plantear hipótesis alternativas sobre un patrón evolutivo, el siguiente paso clave es:
...
**9.** Respecto a las mutaciones germinales y somáticas, ¿cuál de las siguientes afirmaciones es correcta?
