---
title: "Quiz 2D: Métodos, Hardy-Weinberg, Mutación y Selección Natural"
...
**2.** En el caso de la anemia falciforme en regiones donde la malaria es común, la persistencia del alelo S se explica mejor por:
...
**4.** ¿Cuál afirmación resume mejor la relación entre mutación y selección natural?
...
**6.** Para sustentar la hipótesis de que un rasgo es una adaptación producto de la selección natural, es necesario demostrar simultáneamente:
...
**7.** Si una población se desvía de las frecuencias genotípicas esperadas por Hardy-Weinberg, la interpretación más apropiada es:
...
**8.** ¿Cuál afirmación sobre mutaciones puntuales e inserciones/deleciones es correcta?
...
**9.** ¿Cuál de los siguientes escenarios describe mejor la selección diversificadora (disruptiva)?
...
**10.** Respecto a las mutaciones germinales y somáticas, ¿cuál de las siguientes afirmaciones es correcta?
