...
**4.** La aptitud biológica de un organismo:
...
**5.** El ala de un murciélago y el ala de un insecto permiten el vuelo, pero tienen estructuras internas completamente distintas. ¿Cómo se llama este tipo de similitud?
...
**7.** Completa el siguiente enunciado eligiendo la combinación correcta para **(I)**, **(II)** y **(III)**:
...
**8.** ¿Cuál de las siguientes afirmaciones sobre homología es correcta?
...
**9.** ¿Cuál de las siguientes definiciones describe mejor la evolución biológica?
...
**10.** Una población de frijoles cultivada en un invernadero mide en promedio 70 cm de altura. Se toman esquejes (clones genéticamente idénticos) de estas plantas y se cultivan en un campo abierto. Las plantas cultivadas en el campo alcanzan una altura promedio de 50 cm. Este patrón es un ejemplo de:
